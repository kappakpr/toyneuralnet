...
class Perceptron:
    ...
    def guess(self,inputs):
        ...
        output_result = np.add(np.dot(self.weights_oh,self.hidden_layer), self.bias)
        print("output layer \n", output_result, output_result.shape)
        return (self.sigmoid(output_result))
...
''' derivate of sigmoid activatation function for backpropagation'''
    ...
    def train(self,inputs,target):
        ...
        output_error = (target - guess) * self.learning_rate
        ...
        hidden_error = hidden_error * self.learning_rate
